...
running_podman_linux="networking-console-plugin=http://localhost:9001"
running_podman="networking-console-plugin=http://host.containers.internal:9001"
running_docker="networking-console-plugin=http://host.docker.internal:9001"
...
BRIDGE_PLUGINS="${npm_package_consolePlugin_name:="networking-console-plugin"}=http://host.docker.internal:9001"
